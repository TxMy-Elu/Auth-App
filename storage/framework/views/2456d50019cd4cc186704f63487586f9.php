...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-bs-theme="dark">
    ...
    <body class="align-items-center w-100">
        ...
        <main class="align-items-center w-100">
            <form method="POST" action="<?php echo e(route('validationFormulaireInscription')); ?>" class="card w-50 mx-auto mt-5 mb-5">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/html/auth-app2/resources/views/formulaireInscription.blade.php ENDPATH**/ ?>