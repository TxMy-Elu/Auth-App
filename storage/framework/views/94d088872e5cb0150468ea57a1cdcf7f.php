...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-bs-theme="dark">
    ...
    <body class="align-items-center w-100">
        ...
        <main class="align-items-center w-100">
            <form method="POST" action="<?php echo e(route('validationChangementMotDePasse')); ?>" class="card w-50 mx-auto mt-5 mb-5">
                <?php echo csrf_field(); ?>
                <div class="card-body align-items-center text-center">
                    ...
                    <div class="card container">
                        ...
                        <div class="row row-cols-2 card-body">
                            <div class="col">
                                <img src="data:image/png;base64, <?php echo e($qrCode); ?>"/>
                            </div>
                            <div class="col-6">
                                <p>
...
</html><?php /**PATH /var/www/html/auth-app/resources/views/confirmationInscription.blade.php ENDPATH**/ ?>